...
#define CHANNEL_5_IO_MSK    (TSC_GROUP4_IO2)
#define CHANNEL_5_GRP_MSK   (TSC_GROUP4)
#define CHANNEL_5_SRC       (TSC_GROUP4_IDX)
#define CHANNEL_5_DEST      (5)

#define CHANNEL_6_IO_MSK    (TSC_GROUP1_IO3)
#define CHANNEL_6_GRP_MSK   (TSC_GROUP1)
#define CHANNEL_6_SRC       (TSC_GROUP1_IDX)
...
#define BANK_2_MSK_CHANNELS   (CHANNEL_6_IO_MSK | CHANNEL_7_IO_MSK)
